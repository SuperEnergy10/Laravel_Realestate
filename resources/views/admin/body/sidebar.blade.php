            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="uiComponents">
                    <ul class="nav sub-menu">
                        ...
                        <li class="nav-item">
                            <a href="{{route('all.blog.post')}}" class="nav-link">All Post</a>
                        </li>
                        @endif
                        @if(Auth::user()->can('post.add'))

                        <li class="nav-item">
                            <a href="{{route('add.blog.post')}}" class="nav-link">Add Post</a>
                        </li>
                        @endif
                    </ul>
                </div>
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="advancedUI">
                    <ul class="nav sub-menu">
                        ...
                        <li class="nav-item">
                            <a href="{{route('add.roles.permission')}}" class="nav-link">Add Role in Permission</a>
                        </li>
                        <li class="nav-item">
