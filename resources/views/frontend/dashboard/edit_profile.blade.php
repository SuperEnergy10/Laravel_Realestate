...
<section class="sidebar-page-container blog-details sec-pad-2">
    <div class="auto-container">
        <div class="row clearfix">
            ...
            @php
            $id = Auth::user()->id;
            $dataUser = App\Models\User::find($id);
            @endphp
                        ...
                        <div class="post-inner">
                            <div class="post">
                                <figure class="post-thumb"><a href="blog-details.html">
                                        <img src="{{ !empty($dataUser->photo) ?
                    
                    url('upload/user_images/'.$dataUser->photo) : url('upload/no_image.jpg')}}" alt=""></a></figure>
                                <h5><a href="blog-details.html">{{$dataUser->name}} </a></h5>
                                <p>{{$dataUser->email}}</p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="lower-content">
                                ...
                                <form action="{{route('user.profile.store')}}" method="post" class="default-form" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <img id="showImage" src="{{ !empty($dataUser->photo) ?
                    
                    url('upload/user_images/'.$dataUser->photo) : url('upload/no_image.jpg')}}" alt="" style="width:100px; height: 100px">
                                    </div>
