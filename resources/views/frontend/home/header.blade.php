                    ...
                    <nav class="main-menu navbar-expand-md navbar-light">
                        <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                            <ul class="navigation clearfix">
                                ...
                                <li class="dropdown"><a href="{{route('property')}}"><span>Property</span></a>
                                    <ul>
                                ...
                                <li><a href="{{route('agent.login')}}"><span>Agent</span></a>
                                <li><a href="{{route('blog.list')}}"><span>Blog</span></a>

                                <li><a href="{{route('contact')}}"><span>Contact</span></a></li>
                                <li> <a href="{{route('agent.login')}}" class="theme-btn btn-one"><span>+</span>Add Listing</a>
                                </li>
                            </ul>
                        </div>
                    </nav>
