...
$property_1 = App\Models\Property::where('state', optional($skip_state_1)->id)->get();

$skip_state_2 = App\Models\State::skip(2)->first();
$property_2 = App\Models\Property::where('state', optional($skip_state_2)->id)->get();

$skip_state_3 = App\Models\State::skip(3)->first();
$property_3 = App\Models\Property::where('state', optional($skip_state_3)->id)->get();
@endphp
