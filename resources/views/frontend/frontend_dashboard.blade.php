                                    ...
                                    <div class="lower-content">
                                        ...
                                        <div class="other-info-box clearfix">
                                            ...
                                            <ul class="other-option pull-right clearfix">
                                                ...
                                                onclick="wishlistRemove(this.id)"><i class="fa fa-trash"></i></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    <tr>
                        ...
                        <td>
                            <p><a type="submit" class="text-body" id="${value.id}" 
                                                onclick="compareRemove(this.id)"><i class="fa fa-trash"></i></a></p>
                        </td>
