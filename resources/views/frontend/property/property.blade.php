                            ...
                            <div class="widget-content">
                                ...
                                <div class="select-box">
                                    <select name="ptype_id" class="wide">
                                        <option data-display="Type" selected="" disabled="">
                                            Select Type</option>
                                ...
                                <div class="select-box">
                                    <select name="state" class="wide">
                                        <option data-display="State" selected="" disabled="">
                                            Select State</option>
                                ...
                                <div class="select-box">
                                    <select name="bathrooms" class="wide">
                                        <option value="" selected disabled>Max BathRooms</option>
