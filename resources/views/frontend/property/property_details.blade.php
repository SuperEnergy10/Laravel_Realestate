            ...
            <div class="right-column pull-right clearfix">
                <div class="price-inner clearfix">
                    <ul class="category clearfix pull-left">
                        <li>
                            <a href="property-details.html">{{ optional($property->type)->type_name ?? '' }}</a>
                        </li>
                ...
                <div class="property-details-content">
                    ...
                    <div class="details-box content-widget">
                        ...
                        <ul class="list clearfix">
                            ...
                            <li>Rooms: <span>{{$property->bedromms}}</span></li>
                            <li>Garage Size: <span>{{$property->garage_size}}</span></li>
                            <li>Property Price: <span>{{$property->property_code}}</span></li>
                            <li>Property Type: <span>{{ optional($property->type)->type_name ?? 'N/A' }}</span></li>
                    ...
                    <div class="location-box content-widget">
                        ...
                        <ul class="info clearfix">
                            ...
                            <li><span>State/County:</span> {{ optional($property['pstate'])->state_name ?? 'N/A' }}</li>
                    ...
                    <div class="statistics-box content-widget">
                        ...
                        <figure class="image-box">
                            <iframe width="560" height="315" src="{{$property->property_video}}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                        </figure>
                    </div>
                ...
                <div class="property-sidebar default-sidebar">
                        ...
                        <div class="author-box">
                            ...
                            <div class="inner">
                                ...
                                <ul class="info clearfix">
                                    ...
                                    <li><i class="fas fa-phone"></i><a href="tel:03030571965">0123456789</a></li>
                                </ul>
                    ...
                    url('upload/agent_images/'.$property->user->photo) : url('upload/no_image.jpg')}}" alt=""></figure>
                            <div class="inner">
                                ...
                                @auth
                                <div id="app">
                                    <send-message :receiverid="{{$property->agent_id}}"
                        ...
                        <div class="form-inner">
                            ...
                            <form action="{{route('property.message')}}" method="post" class="default-form">
                                ...
                                <div class="form-group">
                                    <input type="text" name="msg_name" value="{{$userData->name}}" placeholder="Your name">
                                </div>
                                <div class="form-group">
                                    <input type="email" name="msg_email" value="{{$userData->email}}" placeholder="Your Email">
                                </div>
                                <div class="form-group">
                                    <input type="text" name="msg_phone" value="{{$userData->phone}}" placeholder="Phone">
                                </div>
                                <div class="form-group">
                    ...
                    <div class="feature-block-one wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            <div class="image-box">
                                ...
                                <span class="category">{{ optional($item->type)->type_name ?? 'N/A' }}</span>
                            </div>
