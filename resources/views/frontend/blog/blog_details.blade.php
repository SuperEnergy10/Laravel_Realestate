        ...
        <div class="row clearfix">
            <div class="col-lg-8 col-md-12 col-sm-12 content-side">
                <div class="blog-details-content">
                        ...
                        <div class="inner-box">
                            ...
                            <div class="lower-content">
                                ...
                                <ul class="post-info clearfix">
                                    <li class="author-box">
                                        <figure class="author-thumb"><img src="{{ !empty($blog->user->photo) ?
                    
                    url('upload/admin_images/'.$blog->user->photo) : url('upload/no_image.jpg')}}" alt=""></figure>
                    ...
                    ->where('parent_id', null)->limit(5)->get();
                        ...
                        <div class="comment-box">
                            ...
                            <div class="comment">
                                <figure class="thumb-box">
                                    <img src="{{ !empty($com->user->photo) ?
                    
                    url('upload/user_images/'.$com->user->photo) : url('upload/no_image.jpg')}}" alt="">
                                </figure>
                    ...
                    <div class="comments-form-area">
                        ...
                        @else
                        <p><b>For add comment, You need to login first</b><a href="{{route('login')}}"> Login here</a></p>
                        @endauth
                    </div>
                </div>
            </div>
