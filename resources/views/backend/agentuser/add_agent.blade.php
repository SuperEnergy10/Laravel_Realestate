                    ...
                    <div class="card-body">
                        ...
                        <form id="myForm" method="POST" action="{{route('store.agent')}}" class="forms-sample">
                            ...
                            <div class="mb-3 form-group">
                                ...
                                <input name="name" type="text" class="form-control" id="agent_name">
                               
                            </div>
                            <div class="mb-3 form-group">
                                <label for="agent_email" class="form-label">Agent Email</label>
                                <input name="email" type="email" class="form-control" id="agent_email">
                            ...
                            <div class="mb-3 form-group">
                                ...
                                <input name="address" type="text" class="form-control" id="agent_address">
                               
                            <div class="mb-3 form-group">
                                <label for="agent_password" class="form-label">Agent Password</label>
                                <input name="password" type="password" class="form-control" id="agent_password">
